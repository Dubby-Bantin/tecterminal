...
const Services = () => {
  return (
    <section>
      ...
      <div className="flex flex-col lg:flex-row lg:justify-around lg:flex-wrap-reverse gap-6 px-6">
        <img
          src={photo}
          alt="Image illustrating tech industry"
        ...
        <div className="lg:w-1/2 flex flex-col gap-5 px-5 text-justify text-xl">
          <p>
            • Africa is one of the emerging tech landscapes in the digital
            transforming era.
          </p>
          <p>
          ...
          <p>
            ...
            growth rate (2021-2025) of 13.27% resulting in a market volume of US
          ...
          <p>
            • Almost every booming industry in technology is data-driven. Hence,
            there is an immense demand for technology-skilled professionals
            across the region.
          </p>
        </div>
      </div>
