  ...
  return (
    <>
        ...
        <section className='h-[88.5vh] bg-slate-400 relative'>
            ...
            <div className="flex flex-col gap-4 absolute top-0 text-white h-full justify-center px-10">
        ...
        <section className="h-[80vh] bg-primaryBlue2 mt-[8rem]">
            <div className="w-full h-[90vh] px-10 absolute overflow-hidden mt-[-8rem]">
        ...
        <section>
            ...
            <div className="text-center px-[15rem] bg-[#ffffffe3] rounded-[100%] -mt-16">
