      ...
      <div className="flex justify-between lg:flex-row flex-col gap-6">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col">
            ...
            <span className="lg:w-[70%]">
              ASTA Gallery Plaza, Plot 1185 Cadastral Zone B06 Mabushi District,
              Abuja - Nigeria.
            </span>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-1 items-center">
              <Link to="tel:+2348033384978" className="underline">
                0803 338 4978
              </Link>
              ,
              <Link to="tel:+2349038624006" className="underline">
                0903 862 4006
              </Link>
            </div>
            <Link to="malito:info@tecterminal.com" className="underline">
              info@tecterminal.com
            </Link>
          </div>
          ...
          {quickLinks_1.map((link) => (
            <div className="" key={link.title}>
              ...
              <div className="flex gap-1 text-gray-500 underline mt-1">
                ...
                <Link to={link.location} key={link.title}>
                  {link.address}
                </Link>
              </div>
