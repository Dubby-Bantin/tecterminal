...
const PastData = () => {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-[90vh] h-auto w-full"
      style={{
      ...
      <div className="flex flex-col justify-center lg:gap-[6rem] gap-12 w-full h-full bg-[#05051d88] text-white lg:px-10 px-6 py-16">
        <div className="flex gap-6 flex-wrap lg:flex-nowrap">
          <div className="lg:w-[50%] w-full">
            <span className="text-lg font-semibold lg:text-white text-primaryYellow">
              Innovative
            </span>
            <h2 className="font-bold lg:text-5xl text-3xl lg:leading-[4rem] mt-2">
              Experience the Power of IT Solutions
            </h2>
          </div>

          <div className="lg:w-[50%] w-full">
            <p className="text-gray-300">
              Tecterminal is a leading Information Technology Services and
              Consultancy firm in Nigeria, providing innovative IT solutions to
              various sectors. With a focus on quality, on-time delivery, and
              competitive pricing, we are committed to enhancing customer
              relationships and showcasing our technical expertise.
            </p>
